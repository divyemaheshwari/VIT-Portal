...
?>
 ...
 <li class="dropdown">
  ...
  <script type="text/javascript">
   ...
   function FreezeDone(testID)
       {
           
            alert("Test has been freezed for Test ID:"+testID);
            
            window.open("teacher_login/tschedule.php",target='_self');         
       }

    function RemoveKeyDone(testID)
    {
       alert("Key has been removed for Test ID"+testID);
   ...
   // alert('addButtonFlag: '+addButtonFlag);
    ...
    var TimingsForm=document.createElement("form");
      ...
      TimingsForm.setAttribute("action","teacher_login/schedule2.php");
      TimingsForm.setAttribute("id","ChangeTime");
          ...
          newbutt1.setAttribute("name","timesub");
              ...
              spantime.setAttribute("class","glyphicon glyphicon-time");
              newbutt1.appendChild(spantime);
   ...
   // parentDiv.appendChild(newbutt5);
    ...
    assessform.setAttribute("action","teacher_login/tassessment.php");
    ...
    newbutt6.setAttribute("class","btn btn-info");
     ...
     var spantime=document.createElement('span');
    spantime.setAttribute("class","glyphicon glyphicon-list-alt");
    newbutt6.appendChild(spantime);
...
<body>
    ...
    <center><h3>Tests List</h3></center><br>
    
    <div class="container">

    <?php
   require('tshowtests.php');
     ?>
    </div>
  ...
  <?php
             if(isset($_POST['FreezeButton']))
             {
               ...
               echo "<script> FreezeDone(".$StatusTestId."); </script>";
             ...
             if(isset($_POST['RemoveBeginKeyButton']))
             {
                ...
                echo "<script> RemoveKeyDone(".$BeginKeyStatusTestId."); </script>";
