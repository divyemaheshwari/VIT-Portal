...
<?php
    $servername = "localhost";
        ...
        while($row = $result->fetch_assoc()){
              ...
              echo "<b>Class ID(s) under the test:</b> ";
              ...
              echo "<br><button onClick='create(this)' class='btn btn-default'><span class='glyphicon glyphicon-search'></span>&nbsp;&nbsp;SETTINGS</button></div><br><br>"; 
              echo "<br>";
         }
