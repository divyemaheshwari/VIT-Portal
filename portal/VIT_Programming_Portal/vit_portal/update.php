...
if(isset($_POST["updatesubmit"]))
{
	...
	$query = "SELECT Subject,Problem_Title,Option_1,Option_2,Option_3,Option_4,Answer,Tag1,Tag2 FROM problems where Problem_id=?;";
...
if ($check == 1)
{
	...
	$query="UPDATE `problems` SET `Tag1` = ?,`Tag2` = ?,`Subject`=?,`Problem_Title`=?,`Description_Path`=?,`question_mark`=?,`Option_1`=?,`Option_2`=?,`Option_3`=?,`Option_4`=?,`Answer`=?,`Type`=? WHERE Problem_id=?;";
...
$query1 = "SELECT Subject,Problem_Title,Option_1,Option_2,Option_3,Option_4,Answer,Tag1,Tag2 FROM problems where Problem_id=?;";
