...
if ($check == 1)
{
	$query = "INSERT INTO `problems`(`Tag1`,`Tag2`,`Subject`,`Problem_Title`, `Description_Path`, `question_mark`, `Option_1`, `Option_2`, `Option_3`, `Option_4`, `Answer`, `Type`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
if (isset($_POST["subjectsubmit"])) {
	...
	$query = "SELECT * FROM problems WHERE subject = ? AND (Tag1 = ? or Tag2=?)";
