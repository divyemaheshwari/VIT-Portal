...
<body>
	...
	<div class ="container" style="border-radius: 20px; border: 2px solid black; padding-top: 20px"> 
		...
		<form name="myForm_4" action="beginkey.php" method="post" >
			...
			<button type="submit" class="btn btn-primary" value="submit" name="submit_beginkey" style="margin-right:50px">Set Begin Key</button><br><br><br><br><br>
		</form>
	</div><br><br>

	<?php
	if(isset($_POST["submit_beginkey"])) 
{    							 $var=$_POST["testid"]; //test id rom the faculty page
...
$check = 1;
				...
				{  $check=0;
					...
					if ($check == 0)
					{
										 $var=1; //test id from the faculty page
										 $removekey=1;
